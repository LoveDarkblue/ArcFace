...
public class DetecterActivity extends Activity implements OnCameraListener, View.OnTouchListener, Camera.AutoFocusCallback {
    ...
    public static final int DETECTER_RESULT_OK = 11;
    public static final int DETECTER_RESULT_NO = 12;
    ...
    class FRAbsLoop extends AbsLoop {
        ...
        List<FaceDB.FaceRegist> mResgist = Application.getInstance(getApplicationContext()).mFaceDB.mRegister;
